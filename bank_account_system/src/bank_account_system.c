...
#define BACKGROUND2 "\033[42m"
#define BACKGROUND3 "\033[44m"
#define BACKGROUND4 "\033[46m"
#define BACKGROUND5 "\033[100m"
#define BACKGROUND6 "\033[102m"
#define BACKGROUND7 "\033[104m"
#define BACKGROUND8 "\033[106m"
#define BACKGROUND9 "\033[40m"
#define BACKGROUND10 "\033[42m"
#define BACKGROUND11 "\033[44m"
#define BACKGROUND12 "\033[46m"
#define BACKGROUND13 "\033[100m"
#define BACKGROUND14 "\033[102m"
#define BACKGROUND15 "\033[104m"
#define BACKGROUND16 "\033[106m"
...
int main()
{
	...
	// Creating a Main
	// menu for the user
	printf(BACKGROUND10 GREEN"WELCOME TO BANK ACCOUNT SYSTEM\n\n"RESET  );
	gotoxy(18, 5);

	printf( BACKGROUND12 CYAN"**********************************"RESET);
	gotoxy(25, 7);

	printf(MAGENTA"DEVELOPER-sumangal karan"RESET);

	gotoxy(20, 10);
	printf(GREEN"1.... CREATE A BANK ACCOUNT");

	gotoxy(20, 12);
	printf(YELLOW"2.... ALREADY A USER? SIGN IN");
	gotoxy(20, 14);
	printf(RED"3.... EXIT\n\n");
